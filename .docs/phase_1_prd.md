...
*   **Frontend:** Next.js (React) browser client with "Date" and "Notes" tabs.
...
### D. Insight Extraction (Data Stream Preparation) [PENDING]
The system must prepare three distinct streams for the Phase 2 Zipper:
1.  **Sparrow Transcript:** The full text of the interaction.
...
4.  **Data Capture:** System stores raw JSON logs for the transcript and tool calls for distillation. [PENDING]
